...
\begin{figure}
\epsfxsize=13cm
\centerline{\epsfbox{figures/SAGA_rot}}
...
\begin{figure}
\epsfysize=3cm
\centerline{\epsfbox{figures/chain2}}
...
\begin{figure}
\epsfxsize=11cm
\centerline{\epsfbox{figures/figure_1}}
...
\begin{figure}
\epsfxsize=9cm
\centerline{\epsfbox{figures/figure_2}}
...
\begin{figure}
\epsfxsize=8cm
\centerline{\epsfbox{figures/figure_3}}
...
\epsfxsize=16.cm
%\epsfysize=15.cm
\centerline{\epsfbox{figures/covplot}}
...
\begin{figure}
\epsfxsize=12cm
\centerline{\epsfbox{figures/layer11_ppd}}
...
\begin{figure}
\epsfxsize=12cm
\centerline{\epsfbox{figures/layer11_uni}}
...
\begin{figure}
\epsfxsize=12cm
\centerline{\epsfbox{figures/layer11_fit}}
...
\begin{figure}
\epsfxsize=12cm
\centerline{\epsfbox{figures/hori_10db2}}
...
\begin{figure}
\epsfxsize=12cm
\centerline{\epsfbox{figures/sspmis}}
...
\begin{figure}
\epsfxsize=12cm
\centerline{\epsfbox{figures/sspmisa_ppd}}
...
\begin{figure}
\epsfxsize=12cm
\centerline{\epsfbox{figures/sspmisa_2ppd}}
...
\begin{figure}
\epsfxsize=12cm
\centerline{\epsfbox{figures/sspmisa_amb}}
...
\begin{figure}
\epsfxsize=12cm
\centerline{\epsfbox{figures/1dppd}}
...
\begin{figure}
\epsfxsize=15cm
\centerline{\epsfbox{figures/2dppd}}
...
\begin{figure}
\epsfxsize=10cm
\centerline{\epsfbox{figures/fig5abc}}
\centerline{\epsfbox{figures/fig5d}}
...
\begin{figure}
\epsfxsize=14cm
\centerline{\epsfbox{figures/pg3}}
...
\begin{figure}
\epsfxsize=12cm
\centerline{\epsfbox{figures/source}}
...
\begin{figure}
\epsfxsize=13.5cm
\centerline{\epsfbox{figures/tl_malta_rd_fit}}
...
\begin{figure}
\epsfxsize=10cm
\centerline{\epsfbox{figures/waa_ppd}}
...
\begin{figure}
\epsfxsize=13cm
\centerline{\epsfbox{figures/waa_fit}}
...
\begin{figure}
\epsfxsize=10cm
\centerline{\epsfbox{figures/waa_lf_freq}}
...
\begin{figure}
\epsfxsize=10cm
\centerline{\epsfbox{figures/waa_lf_time}}
...
\begin{figure}
\epsfxsize=14cm
\centerline{\epsfbox{figures/rev}}
...
{sf GAMA} has been used for Combined geoacoustic inversion of propagation and reverberation data \cite{nielsen09}.  Another example of using {\sf GAMA} is near filed inversion when the platform is towing both source and horizontal array.
The example below {\bf map2k\_phla2000067091700}} is for the latter case.
...
\begin{figure}
\epsfxsize=14cm
\centerline{\epsfbox{figures/sdc20dborca}}
...
\begin{figure}
\epsfxsize=15cm
\centerline{\epsfbox{figures/tc1v1lay}}
...
\begin{figure}
\epsfxsize=10cm
\centerline{\epsfbox{figures/em_environment}}
\caption{Modified vertical refractivity profile for a tri-linear profile.}
\label{fig:em_env}
\end{figure}
\begin{figure}
\epsfxsize=12cm
\centerline{\epsfbox{figures/tpem_ex_ppd}}
...
\begin{figure}
\epsfxsize=12cm
\centerline{\epsfbox{figures/tpem_ex_fit}}
...
\begin{figure}
\epsfxsize=9cm
\centerline{\epsfbox{figures/tpem_ex_con}}
...
clockwise when looking from  the origin along the positive axis.
   \begin{figure}
      \epsfxsize=10cm \centerline{\epsfbox{figures/covertcoord}}
...
\bibitem{nielsen09} P.L.~Nielsen and C. Harrison. Combined geoacoustic inversion of propagation and reverberation data. {\it IEEE Journal of Oceanic Engineering}, {\bf 34}, pp. 51-62, 2009.
