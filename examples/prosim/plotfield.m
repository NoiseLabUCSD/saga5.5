function [st,pulse,t,depth]=plotfield(filename,strng,frq,dpth_rng,col);
%
...
% by TPEMBB
% Peter Gerstoft Oct 96
%----------------------
% read the output from tpem, written to file duct.trf
