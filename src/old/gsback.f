...
c     Peter Gerstoft 02
      ...
      REAL eps,nye,tot,xdum,epssumsq,epssum
...
c---  
      ...
      WRITE(*,*)' .... SAGA Gibbs sampling module ....'
...
c***********************************************************      
      USE global
      INCLUDE 'comopt.h'
      REAL ppd1(mpar,mdig), ppd2(mpar,mdig),epsmax
      REAL diff1,tot,eps(mpar)
      INTEGER i, jp, imax
      epsmax=0
      DO i=1,nparm
         diff1=0
