...
c***  this is sector length
             R_slngth(par3(i))= fval(model(i,iq),i)*1000
         ELSE
...
c***  this is the array shape
         ...
         ELSEIF (par2phy(i).EQ.27) THEN
c***  this is sector length
             R_slngth(par3(i))= fval(modelb(i),i)*1000
         ELSE
            WRITE(*,*) ' setmodelbest: snaprdinter: option not defined'
         ENDIF
      ENDDO
      END
...
c***  this is the array shape
          ...
          ELSEIF (par2phy(i).EQ.27) THEN
c***  this is sector length
             R_slngth(par3(i))= x(i)*1000
        ELSE
            WRITE(*,*) 'setmodelreal snapinter: option not defined'
         ENDIF
      ENDDO
      END
c********************
...
c***  this is the array shape
          ...
          ELSEIF (par2phy(i).EQ.27) THEN
c***  this is sector length
             x(i)= R_slngth(par3(i))/1000
         ELSE
            WRITE(*,*) 'getmodelreal snapinter: option not defined'
         ENDIF
      ENDDO
      END
c*********************
...
c***  this is the array shape
      ...
      ELSEIF (ixpar.EQ.27) THEN
c***  this is sector length
             R_slngth(iz)=  theta*1000
      ELSE
         WRITE(*,*) ' setmodelx snapinter: option not defined'
      ENDIF
...
c***  this is the array shape
         ...
         ELSEIF (par2phy_eof(i).EQ.27) THEN
c***  this is sector length
             R_slngth(par3_eof(i))= x(i)*1000
        ELSE
            WRITE(*,*) 'setmodeleof snapinter: option not defined'
         ENDIF
